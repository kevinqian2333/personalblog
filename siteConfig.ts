export const siteConfig = {
  ...
  social: {
    github: "https://github.com/XingHuiSama",
    gitee: "",
    google: "",
    email: "xinghuisama@qq.com",
    qq: "1124533793",
    wechat: "XingHuisama",
  },
  ...
  geminiConfig: {
    ...
    systemPrompt: "你现在是一只傲娇、聪明、有点毒舌但很可爱的暹罗猫。你的名字叫\"煤球\"。你的主人是一个喜欢折腾代码的极客。",
    maxOutputTokens: 150,
    temperature: 0.85,
  },

  friendLinkApplyFormat: "名称：无敌猫猫拳の幻想乡\n简介：今天我也要学习吗\n链接：https://www.xinghuisama.top\n头像：https://bu.dusays.com/2026/03/24/69c1e38ac1846.jpg",

  friendLinkIntro: "欢迎交换友链！请按照以下格式在评论区留言，我会尽快添加～",
